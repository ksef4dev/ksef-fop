                                ...
                                <xsl:if test="crd:Fa/crd:Platnosc/crd:RachunekBankowy/crd:NrRB">
                                    <fo:table-row>
                                        ...
                                        <fo:table-cell
                                            ...
                                            <fo:block>
                                                <xsl:value-of
                                                        select="crd:Fa/crd:Platnosc/crd:RachunekBankowy/crd:NrRB"/>
                                            </fo:block>
                                        </fo:table-cell>
                                    </fo:table-row>
                                </xsl:if>
                                <xsl:if test="crd:Fa/crd:Platnosc/crd:RachunekBankowy/crd:NazwaBanku">
                                    <fo:table-row>
                                        ...
                                        <fo:table-cell
                                            ...
                                            <fo:block>
                                                <xsl:value-of
                                                        select="crd:Fa/crd:Platnosc/crd:RachunekBankowy/crd:NazwaBanku"/>
                                            </fo:block>
                                        </fo:table-cell>
                                    </fo:table-row>
                                </xsl:if>
                                <xsl:if test="crd:Fa/crd:Platnosc/crd:RachunekBankowy/crd:OpisRachunku">
                                    <fo:table-row>
                                        ...
                                        <fo:table-cell
                                            ...
                                            <fo:block>
                                                <xsl:value-of
                                                        select="crd:Fa/crd:Platnosc/crd:RachunekBankowy/crd:OpisRachunku"/>
                                            </fo:block>
                                        </fo:table-cell>
                                    </fo:table-row>
                                </xsl:if>
